...
import {
  ...
  AlertTriangle, ActivitySquare, LineChart as LineChartIcon
} from 'lucide-react';
import { 
  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content">
        ...
        {data.hypothesis_layer && data.hypothesis_layer.pattern_identification && (
          <section>
            ...
            <div className="ai-warning" style={{ marginBottom: '1.5rem' }}>
      ...
      <footer style={{ textAlign: 'center', padding: '2rem 1rem', color: 'var(--text-muted)', fontSize: '0.875rem', borderTop: '1px solid var(--border-color)', marginTop: '2rem' }}>
        Built by{' '}
        <a
          href="https://pedro-tanure-veloso.github.io/"
          target="_blank"
