...
# Convention note: BCKM's paper publishes P in the transpose of the
# code's textbook ``state_{t+1} = P · state_t`` convention. See
# ``bca_core/constants.py`` for the full story. Do not re-transcribe
# Table 8 here.
